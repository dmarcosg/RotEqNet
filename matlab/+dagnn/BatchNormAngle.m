classdef BatchNormAngle < dagnn.ElementWise
  properties
    numChannels
    epsilon = 1e-4
  end
  ...
  methods
    function outputs = forward(obj, inputs, params)
      if strcmp(obj.net.mode, 'test')
        outputs{1} = vl_nnbnormangle(inputs{1}, params{1}, params{2}, ...
                                'moments', params{3}, ...
                                'epsilon', obj.epsilon) ;
      else
        outputs{1} = vl_nnbnormangle(inputs{1}, params{1}, params{2}, ...
    ...
    function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
      [derInputs{1}, derParams{1}, derParams{2}, derParams{3}] = ...
        vl_nnbnormangle(inputs{1}, params{1}, params{2}, derOutputs{1}, ...
                   'epsilon', obj.epsilon) ;
    ...
    % ---------------------------------------------------------------------
    function obj = BatchNormAngle(varargin)
      obj.load(varargin{:}) ;
    end
