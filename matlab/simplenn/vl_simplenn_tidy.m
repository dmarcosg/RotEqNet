...
for l = 1:numel(net.layers)
  ...
  switch layer.type
    case {'conv', 'convt', 'bnorm','convsteer','bnormangle'}
  ...
  if strcmp(layer.type, 'bnorm') || strcmp(layer.type, 'bnormangle')
  ...
  switch layer.type
    ...
    case {'poolangle','poolangle_single'}
      defaults = [ defaults {...
        'angle_n', 8,...
        'max_angle', 360,...
        'opts', struct()}] ;
    ...
    case 'normalizelp'
      defaults = [ defaults {...
        'p', 2,'epsilon',1e-4,'norm',1}] ;

    case {'normalize', 'lrn'}
      defaults = [ defaults {...
        'param', [5 1 0.0001/5 0.75]}] ;

    case {'pdist','pdist_siam'}
      defaults = [ defaults {...
        'noRoot', false, ...
        'aggregate', false, ...
        'p', 2, ...
